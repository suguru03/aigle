...
const { INTERNAL, PENDING, call2, callProxyReciever } = require('./util');

class AigleSeires extends AigleProxy {
...
module.exports = { AigleSeires, AigleSeriesArray, AigleSeriesObject };
