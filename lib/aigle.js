...
class Aigle extends AigleCore {
   ...
   */
  all() {
    return addProxy0(this, AigleAll);
  }
   ...
   */
  parallel() {
    return addProxy0(this, AigleParallel);
  }
   ...
   */
  each(iterator) {
    return addProxy1(this, Each, iterator);
  }
   ...
   */
  eachSeries(iterator) {
    return addProxy1(this, EachSeries, iterator);
  }
   ...
   */
  map(iterator) {
    return addProxy1(this, Map, iterator);
  }
   ...
   */
  mapSeries(iterator) {
    return addProxy1(this, MapSeries, iterator);
  }
   ...
   */
  mapValues(iterator) {
    return addProxy1(this, MapValues, iterator);
  }
   ...
   */
  mapValuesSeries(iterator) {
    return addProxy1(this, MapValuesSeries, iterator);
  }
   ...
   */
  filter(iterator) {
    return addProxy1(this, Filter, iterator);
  }
   ...
   */
  filterSeries(iterator) {
    return addProxy1(this, FilterSeries, iterator);
  }
   ...
   */
  reject(iterator) {
    return addProxy1(this, Reject, iterator);
  }
   ...
   */
  rejectSeries(iterator) {
    return addProxy1(this, RejectSeries, iterator);
  }
   ...
   */
  find(iterator) {
    return addProxy1(this, Find, iterator);
  }
   ...
   */
  findSeries(iterator) {
    return addProxy1(this, FindSeries, iterator);
  }
   ...
   */
  pick(iterator) {
    return addProxy1(this, Pick, iterator);
  }
   ...
   */
  pickSeries(iterator) {
    return addProxy1(this, PickSeries, iterator);
  }
   ...
   */
  omit(iterator) {
    return addProxy1(this, Omit, iterator);
  }
   ...
   */
  omitSeries(iterator) {
    return addProxy1(this, OmitSeries, iterator);
  }
   ...
   */
  sortBy(iterator) {
    return addProxy1(this, SortBy, iterator);
  }
   ...
   */
  sortBySeries(iterator) {
    return addProxy1(this, SortBySeries, iterator);
  }
   ...
   */
  some(iterator) {
    return addProxy1(this, Some, iterator);
  }
   ...
   */
  someSeries(iterator) {
    return addProxy1(this, SomeSeries, iterator);
  }
   ...
   */
  every(iterator) {
    return addProxy1(this, Every, iterator);
  }
   ...
   */
  everySeries(iterator) {
    return addProxy1(this, EverySeries, iterator);
  }
   ...
   */
  concat(iterator) {
    return addProxy1(this, Concat, iterator);
  }
   ...
   */
  concatSeries(iterator) {
    return addProxy1(this, ConcatSeries, iterator);
  }
   ...
   */
  groupBy(iterator) {
    return addProxy1(this, GroupBy, iterator);
  }
   ...
   */
  groupBySeries(iterator) {
    return addProxy1(this, GroupBySeries, iterator);
  }
  ...
  _callResolve() {
    ...
    while (_receivers.length !== 0) {
      const { receiver, _onFulfilled } = _receivers.shift();
      if (receiver instanceof AigleProxy) {
        receiver._callResolve(_value, _key);
      } else {
        callResolve(receiver, _onFulfilled, _value);
      }
    }
  }
  ...
  _callReject() {
    ...
    this._receivers = undefined;
    while (_receivers.length !== 0) {
      const task = _receivers.shift();
      callReject(task.receiver, task.onRejected, _value);
    }
  }
...
function addProxy0(promise, Proxy) {
  switch (promise._resolved) {
  case 0:
    const receiver = new Proxy(PENDING);
    if (promise._receiver === undefined) {
      promise._receiver = receiver;
    } else {
      if (!promise._receivers) {
    ...
    return receiver._promise;
  case 1:
    return new Proxy(promise._value)._execute();
  case 2:
    return Aigle.reject(promise._value);
  }
}

function addProxy1(promise, Proxy, iterator) {
  switch (promise._resolved) {
  case 0:
    const proxy = new Proxy(iterator, PENDING);
...
function addProxy2(promise, Proxy, arg1, arg2) {
  switch (promise._resolved) {
  case 0:
    const proxy = new Proxy(arg1, arg2, PENDING);
    promise._receiver = proxy;
    return proxy._promise;
  case 1:
...
function addProxy3(promise, Proxy, arg1, arg2, arg3) {
  switch (promise._resolved) {
  case 0:
    const proxy = new Proxy(arg1, arg2, arg3, PENDING);
    promise._receiver = proxy;
    return proxy._promise;
  case 1:
