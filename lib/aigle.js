...
class Aigle extends AigleCore {
  ...
  eachLimit(limit, iterator) {
    return addProxyLimit(this, EachLimit, limit, iterator);
  }
  ...
  mapLimit(limit, iterator) {
    return addProxyLimit(this, MapLimit, limit, iterator);
  }
  ...
  mapValuesLimit(limit, iterator) {
    return addProxyLimit(this, MapValuesLimit, limit, iterator);
  }
  ...
  filterLimit(limit, iterator) {
    return addProxyLimit(this, FilterLimit, limit, iterator);
  }
  ...
  findLimit(limit, iterator) {
    return addProxyLimit(this, FindLimit, limit, iterator);
  }
  ...
  pickLimit(limit, iterator) {
    return addProxyLimit(this, PickLimit, limit, iterator);
  }
  ...
  omitLimit(limit, iterator) {
    return addProxyLimit(this, OmitLimit, limit, iterator);
  }
  ...
  everyLimit(limit, iterator) {
    return addProxyLimit(this, EveryLimit, limit, iterator);
  }
  ...
  concatLimit(limit, iterator) {
    return addProxyLimit(this, ConcatLimit, limit, iterator);
  }
  ...
  groupByLimit(limit, iterator) {
    return addProxyLimit(this, GroupByLimit, limit, iterator);
  }
  ...
  _callResolve() {
    ...
    while (_receivers.length !== 0) {
      ...
      callResolve(task.receiver, task.onFulfilled, _value);
    }
  }
...
function addProxyLimit(promise, Proxy, limit, iterator) {
  switch (promise._resolved) {
  case 0:
    const proxy = new Proxy(limit, iterator, PENDING);
    promise._receiver = proxy;
    return proxy._promise;
  case 1:
    return new Proxy(limit, iterator, promise._value)._execute();
  case 2:
    return Aigle.reject(promise._value);
  }
}
