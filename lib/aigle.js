...
class Aigle extends AigleCore {
  ...
  /**
   * `Aigle#each` executes `Aigle.each` using previous promise value.
   * The value will be assigned as a first argument to `Aigle.each`.
  ...
  /**
   * `Aigle#eachSeries` is the same as [`Aigle.each`](https://suguru03.github.io/aigle/docs/Aigle.html#each), but it will work in series.
   * @param {Function} iterator
   * @example
   * const order = [];
   * const collection = [1, 4, 2];
  ...
  /**
   * `Aigle#eachLimit` is the same as [`Aigle.each`](https://suguru03.github.io/aigle/docs/Aigle.html#each) and
  ...
  /**
   * `Aigle#concat` executes `Aigle.concat` using previous promise value.
   * The value will be assigned as a first argument to `Aigle.concat`.
   * @param {Function} iterator
   * @example
   * const order = [];
   * const collection = [1, 4, 2];
  ...
  /**
   * `Aigle#concatSeries` is the same as [`Aigle.concat`](https://suguru03.github.io/aigle/docs/Aigle.html#concat), but it will work in series.
   * @param {Function} iterator
   * @example
   * const order = [];
   * const collection = [1, 4, 2];
  ...
  /**
   * `Aigle#concatLimit` is the same as [`Aigle.concat`](https://suguru03.github.io/aigle/docs/Aigle.html#concat)
