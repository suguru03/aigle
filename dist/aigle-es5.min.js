      ...
      2: [
        function(mr, dr, t) {
          (function(l) {
              ...
              x = (function(e) {
                ...
                return (
                  ...
                  (n.prototype.catch = function(t) {
                    ...
                    return fr(this, new n(h), void 0, t);
                  }),
                  ...
                  (n.prototype.isCancelled = function() {
                    return this._value instanceof ur;
                  }),
                  ...
                  (n.prototype.cancel = function() {
                    if (this._execute !== _r && 0 === this._resolved) {
                      ...
                      (this._resolved = 2),
                        (this._value = new ur('late cancellation observer')),
                  ...
                  (n.prototype.delay = function(t) {
                    return fr(this, new Fi(t));
                  }),
                  (n.prototype.timeout = function(t, e) {
                    return yr(this, new zi(t, e));
                  }),
                    ...
                    if (
                      ...
                      t instanceof u
                        ...
                        : this._key === h
                          ...
                          : v(t, this._onFulfilled, this._value),
                      this._receivers)
                    ) {
                      var e = this._value,
                        i = this._key,
                      ...
                      for (var s = -1, o = r.array; ++s < r.length; ) {
                        var n = o[s],
                          c = n.receiver,
                          l = n.onFulfilled;
                        c instanceof u ? c._callResolve(e, i) : v(c, l, e);
                      }
                    }
                  }),
            ...
            (x.prototype._execute = _r), (dr.exports = x), (dr.exports.default = x);
            var o = mr('./all'),
              n = o.all,
              R = o.All,
              S = mr('./attempt'),
              ...
              sr = mr('./debug'),
              or = sr.resolveStack,
              nr = sr.reconstructStack,
              cr = mr('./internal/mixin').createProxy;
            (x.VERSION = i),
              ((x.Aigle = x).resolve = hr),
              ...
              (x.config = function(t) {
                ...
                void 0 !== t.cancellation && (x.prototype._execute = t.cancellation ? pr : _r);
              }),
              (x.longStackTraces = function() {
                g = !0;
              });
            var lr = mr('./error'),
              ur = lr.CancellationError,
              ar = lr.TimeoutError;
            function hr(t) {
            ...
            function yr(t, e) {
              return g && or(e), 0 !== t._resolved && s(t), (t._receiver = e)._promise;
            }
            ...
            (x.CancellationError = ur), (x.TimeoutError = ar);
          }.call(this, mr('_process')));
        },
        {
          './all': 3,
          './attempt': 4,
                      ...
                      (u = h
                        ? (function(e, i, r, s, t) {
                            for (var o = [], n = 0, c = i.length; n < c; ++n)
                              w(i, String(n)) ? o.push(y(e, i, r, s, String(n), !0)) : o.push('');
                            return (
                              t.forEach(function(t) {
                                t.match(/^\d+$/) || o.push(y(e, i, r, s, t, !0));
                              }),
                              o
                            );
                          })(e, i, r, c, n)
                        : n.map(function(t) {
                            return y(e, i, r, c, t, h);
                          })),
                      e.seen.pop(),
                      (function(t, e, i) {
                        if (
