      ...
      2: [
        function(require, module, exports) {
          (function(process) {
            ...
            var FindKeyLimit = ref$29.FindKeyLimit;
            var ref$30 = require('./pickBy');
            var pickBy = ref$30.pickBy;
            var PickBy = ref$30.PickBy;
            var ref$31 = require('./pickBySeries');
            var pickBySeries = ref$31.pickBySeries;
            var PickBySeries = ref$31.PickBySeries;
            var ref$32 = require('./pickByLimit');
            var pickByLimit = ref$32.pickByLimit;
            var PickByLimit = ref$32.PickByLimit;
      ...
      35: [
        function(require, module, exports) {
          ...
          function createSetShorthand(ref) {
            var iterateArrayParallel = ref[0];
            var iterateObjectParallel = ref[1];
