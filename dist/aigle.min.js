      ...
      2: [
        function(e, t) {
          (function(r) {
            ...
            function c(e, t) {
              return E && lr(t), 0 !== e._resolved && y(e), (e._receiver = t), t._promise;
            }
            ...
            class j extends u {
              ...
              isCancelled() {
                return this._value instanceof or;
              }
              value() {
              ...
              cancel() {
                if (this._execute !== i && 0 === this._resolved) {
                  ...
                  (this._resolved = 2),
                    (this._value = new or('late cancellation observer')),
              ...
              delay(e) {
                return a(this, new Mt(e));
              }
              timeout(e, t) {
                return c(this, new Wt(e, t));
              }
              whilst(e, t) {
                return this.then(r => Vt(r, e, t));
              }
              doWhilst(e, t) {
                return this.then(r => Ct(r, e, t));
              }
              until(e, t) {
                ...
                if (0 === this._resolved)
                  return (
                    ...
                    void 0 === this._receiver
                      ...
                      : void (E && ir(this), this._callReject())
                  );
              }
              _callReject() {
                const { _receiver: e } = this;
            ...
            const { all: b, All: A } = e('./all'),
              ...
              { props: B, Props: T } = e('./props'),
              { parallel: O, Parallel: F } = e('./parallel'),
              { series: z, Series: D } = e('./series'),
              { parallelLimit: w, ParallelLimit: M } = e('./parallelLimit'),
              { each: W, Each: V } = e('./each'),
              { eachSeries: C, EachSeries: G } = e('./eachSeries'),
              { eachLimit: U, EachLimit: K } = e('./eachLimit'),
              { map: H, Map: Q } = e('./map'),
              { mapSeries: q, MapSeries: J } = e('./mapSeries'),
              { mapLimit: $, MapLimit: Y } = e('./mapLimit'),
              { mapValues: X, MapValues: Z } = e('./mapValues'),
              { mapValuesSeries: ee, MapValuesSeries: te } = e('./mapValuesSeries'),
              { mapValuesLimit: re, MapValuesLimit: le } = e('./mapValuesLimit'),
              { filter: ie, Filter: se } = e('./filter'),
              { filterSeries: oe, FilterSeries: _e } = e('./filterSeries'),
              { filterLimit: ae, FilterLimit: ce } = e('./filterLimit'),
              { reject: ne, Reject: ue } = e('./reject'),
              { rejectSeries: pe, RejectSeries: me } = e('./rejectSeries'),
              { rejectLimit: ye, RejectLimit: de } = e('./rejectLimit'),
              { find: he, Find: ve } = e('./find'),
              { findSeries: xe, FindSeries: ge } = e('./findSeries'),
              { findLimit: Se, FindLimit: fe } = e('./findLimit'),
              { findIndex: ke, FindIndex: Le } = e('./findIndex'),
              { findIndexSeries: Re, FindIndexSeries: Ee } = e('./findIndexSeries'),
              { findIndexLimit: je, FindIndexLimit: be } = e('./findIndexLimit'),
              { findKey: Ae, FindKey: Ne } = e('./findKey'),
              { findKeySeries: Ie, FindKeySeries: Pe } = e('./findKeySeries'),
              { findKeyLimit: Be, FindKeyLimit: Te } = e('./findKeyLimit'),
              { pick: Oe, Pick: Fe } = e('./pick'),
              { pickBy: ze, PickBy: De } = e('./pickBy'),
              { pickBySeries: we, PickBySeries: Me } = e('./pickBySeries'),
              { pickByLimit: We, PickByLimit: Ve } = e('./pickByLimit'),
              { omit: Ce, Omit: Ge } = e('./omit'),
              { omitBy: Ue, OmitBy: Ke } = e('./omitBy'),
              { omitBySeries: He, OmitBySeries: Qe } = e('./omitBySeries'),
              { omitByLimit: qe, OmitByLimit: Je } = e('./omitByLimit'),
              { reduce: $e, Reduce: Ye } = e('./reduce'),
              { transform: Xe, Transform: Ze } = e('./transform'),
              { transformSeries: et, TransformSeries: tt } = e('./transformSeries'),
              { transformLimit: rt, TransformLimit: lt } = e('./transformLimit'),
              { sortBy: it, SortBy: st } = e('./sortBy'),
              { sortBySeries: ot, SortBySeries: _t } = e('./sortBySeries'),
              { sortByLimit: at, SortByLimit: ct } = e('./sortByLimit'),
              { some: nt, Some: ut } = e('./some'),
              { someSeries: pt, SomeSeries: mt } = e('./someSeries'),
              { someLimit: yt, SomeLimit: dt } = e('./someLimit'),
              { every: ht, Every: vt } = e('./every'),
              { everySeries: xt, EverySeries: gt } = e('./everySeries'),
              { everyLimit: St, EveryLimit: ft } = e('./everyLimit'),
              { concat: kt, Concat: Lt } = e('./concat'),
              { concatSeries: Rt, ConcatSeries: Et } = e('./concatSeries'),
              { concatLimit: jt, ConcatLimit: bt } = e('./concatLimit'),
              { groupBy: At, GroupBy: Nt } = e('./groupBy'),
              { groupBySeries: It, GroupBySeries: Pt } = e('./groupBySeries'),
              { groupByLimit: Bt, GroupByLimit: Tt } = e('./groupByLimit'),
              { join: Ot, Spread: Ft } = e('./join'),
              zt = e('./promisify'),
              Dt = e('./promisifyAll'),
              { delay: wt, Delay: Mt } = e('./delay'),
              Wt = e('./timeout'),
              { whilst: Vt } = e('./whilst'),
              { doWhilst: Ct } = e('./doWhilst'),
              { until: Gt } = e('./until'),
              Ut = e('./doUntil'),
              Kt = e('./retry'),
              Ht = e('./thru'),
              Qt = e('./tap'),
              qt = e('./flow'),
              { times: Jt, Times: $t } = e('./times'),
              { timesSeries: Yt, TimesSeries: Xt } = e('./timesSeries'),
              { timesLimit: Zt, TimesLimit: er } = e('./timesLimit'),
              { using: tr, Disposer: rr } = e('./using'),
              { resolveStack: lr, reconstructStack: ir } = e('./debug'),
              { createProxy: sr } = e('./internal/mixin');
            (j.VERSION = d),
              (j.Aigle = j),
              (j.resolve = l),
              (j.reject = function(e, t) {
                if (2 === arguments.length && 'function' == typeof t) return ne(e, t);
                const r = new j(h);
            ...
            const { CancellationError: or, TimeoutError: _r } = e('./error');
            (j.CancellationError = or), (j.TimeoutError = _r);
        ...
        function(e, t) {
          ...
          const { call3: a, callProxyReciever: c } = e('./util'),
            ...
            [d, h, v, x] = [
              [m, y],
              [m, [s, ...y.slice(1)]],
              [[...m.slice(0, 3), o], [...y.slice(0, 3), o]],
              [[...m.slice(0, 3), _], [...y.slice(0, 3), _]]
            ].map(function(e) {
              const [t, l] = e.map(r);
              return function(e) {
                if (Array.isArray(e))
        ...
        function(e, t) {
          (function(r) {
            ...
            function y(e, t, r, s) {
              ...
              if (!(o > r)) {
                const l = e[t] > e[o] ? t : o;
                (o = m(e, t, r, e[l], s)), y(e, t, o - 1, s), y(e, o, r, s);
              }
            }
            const { AigleCore: d } = e('aigle-core'),
        ...
        function(e, t) {
          ...
          class m extends r {
            ...
            _set(e) {
              ...
              } else if (!e || 'object' != typeof e) (this._rest = 0), (this._result = void 0);
              else if (e[n]) {
                const t = e.size;
        ...
        function(e, t) {
          ...
          function r(e) {
            if (((this._coll = e), (this._iterate = l), Array.isArray(e))) {
              ...
              (this._rest = 0), (this._result = void 0);
            else if (e[p]) {
              this._coll = e[p]();
              const t = e.size;
              if (((this._rest = t), e instanceof Map)) {
