(function(e) {
  ...
  return (function() {
    function _(c, e, t) {
      ...
      for (var l = 'function' == typeof require && require, i = 0; i < t.length; i++) r(t[i]);
      return r;
    }
    return _;
  })()(
    {
      ...
      2: [
        function(e, t) {
          (function(r) {
            ...
            function s(t) {
              ...
              try {
                t(
                  e => {
                    void 0 === t ||
                      (e instanceof j && 0 === e._resolved && (this._parent = e), (t = void 0), R(this, e));
                  },
                  e => {
                    void 0 === t || ((t = void 0), this._reject(e));
                  },
            ...
            function c(e, t) {
              return L && Yt(t, e), 0 !== e._resolved && y(e), (e._receiver = t), t._promise;
            }
            ...
            class j extends u {
              ...
              delay(e) {
                return a(this, new Ot(e));
              }
              timeout(e, t) {
                return c(this, new zt(e, t));
              }
              whilst(e, t) {
                return this.then(r => Dt(r, e, t));
              }
              doWhilst(e, t) {
              ...
              _callResolve() {
                ...
                if (
                  ...
                  e instanceof p
                    ...
                    : this._key === h ? e._resolve(this._value) : k(e, this._onFulfilled, this._value),
                  !!this._receivers)
                ) {
                ...
                if (0 === this._resolved)
                  return (
                    ...
                    void 0 === this._receiver
                      ...
                      : void (L && Xt(this), this._callReject())
                  );
              }
              _callReject() {
                const { _receiver: e } = this;
                if (((this._receiver = void 0), void 0 === e || e === x))
                  return void r.emit('unhandledRejection', this._value);
                if (
                  e !== h &&
                  (e instanceof p
                    ? e._callReject(this._value)
                    : this._key === h ? e._reject(this._value) : f(e, this._onRejected, this._value),
                  !!this._receivers)
                ) {
            ...
            const { all: E, All: A } = e('./all'),
              b = e('./attempt'),
              { race: N, Race: P } = e('./race'),
              { props: B, Props: I } = e('./props'),
              { parallel: T, Parallel: O } = e('./parallel'),
              { each: z, Each: D } = e('./each'),
              { eachSeries: F, EachSeries: w } = e('./eachSeries'),
              { eachLimit: W, EachLimit: M } = e('./eachLimit'),
              { map: V, Map: C } = e('./map'),
              { mapSeries: G, MapSeries: U } = e('./mapSeries'),
              { mapLimit: K, MapLimit: H } = e('./mapLimit'),
              { mapValues: Q, MapValues: q } = e('./mapValues'),
              { mapValuesSeries: J, MapValuesSeries: $ } = e('./mapValuesSeries'),
              { mapValuesLimit: Y, MapValuesLimit: X } = e('./mapValuesLimit'),
              { filter: Z, Filter: ee } = e('./filter'),
              { filterSeries: te, FilterSeries: re } = e('./filterSeries'),
              { filterLimit: le, FilterLimit: ie } = e('./filterLimit'),
              { reject: se, Reject: oe } = e('./reject'),
              { rejectSeries: _e, RejectSeries: ae } = e('./rejectSeries'),
              { rejectLimit: ce, RejectLimit: ne } = e('./rejectLimit'),
              { find: ue, Find: pe } = e('./find'),
              { findSeries: me, FindSeries: ye } = e('./findSeries'),
              { findLimit: de, FindLimit: he } = e('./findLimit'),
              { findIndex: ve, FindIndex: xe } = e('./findIndex'),
              { findIndexSeries: ge, FindIndexSeries: Se } = e('./findIndexSeries'),
              { findIndexLimit: ke, FindIndexLimit: fe } = e('./findIndexLimit'),
              { findKey: Re, FindKey: Le } = e('./findKey'),
              { findKeySeries: je, FindKeySeries: Ee } = e('./findKeySeries'),
              { findKeyLimit: Ae, FindKeyLimit: be } = e('./findKeyLimit'),
              { pick: Ne, Pick: Pe } = e('./pick'),
              { pickBy: Be, PickBy: Ie } = e('./pickBy'),
              { pickBySeries: Te, PickBySeries: Oe } = e('./pickBySeries'),
              { pickByLimit: ze, PickByLimit: De } = e('./pickByLimit'),
              { omit: Fe, Omit: we } = e('./omit'),
              { omitBy: We, OmitBy: Me } = e('./omitBy'),
              { omitBySeries: Ve, OmitBySeries: Ce } = e('./omitBySeries'),
              { omitByLimit: Ge, OmitByLimit: Ue } = e('./omitByLimit'),
              { reduce: Ke, Reduce: He } = e('./reduce'),
              { transform: Qe, Transform: qe } = e('./transform'),
              { transformSeries: Je, TransformSeries: $e } = e('./transformSeries'),
              { transformLimit: Ye, TransformLimit: Xe } = e('./transformLimit'),
              { sortBy: Ze, SortBy: et } = e('./sortBy'),
              { sortBySeries: tt, SortBySeries: rt } = e('./sortBySeries'),
              { sortByLimit: lt, SortByLimit: it } = e('./sortByLimit'),
              { some: st, Some: ot } = e('./some'),
              { someSeries: _t, SomeSeries: at } = e('./someSeries'),
              { someLimit: ct, SomeLimit: nt } = e('./someLimit'),
              { every: ut, Every: pt } = e('./every'),
              { everySeries: mt, EverySeries: yt } = e('./everySeries'),
              { everyLimit: dt, EveryLimit: ht } = e('./everyLimit'),
              { concat: vt, Concat: xt } = e('./concat'),
              { concatSeries: gt, ConcatSeries: St } = e('./concatSeries'),
              { concatLimit: kt, ConcatLimit: ft } = e('./concatLimit'),
              { groupBy: Rt, GroupBy: Lt } = e('./groupBy'),
              { groupBySeries: jt, GroupBySeries: Et } = e('./groupBySeries'),
              { groupByLimit: At, GroupByLimit: bt } = e('./groupByLimit'),
              { join: Nt, Spread: Pt } = e('./join'),
              Bt = e('./promisify'),
              It = e('./promisifyAll'),
              { delay: Tt, Delay: Ot } = e('./delay'),
              zt = e('./timeout'),
              { whilst: Dt } = e('./whilst'),
              { doWhilst: Ft } = e('./doWhilst'),
              { until: wt } = e('./until'),
              Wt = e('./doUntil'),
              Mt = e('./retry'),
              Vt = e('./thru'),
              Ct = e('./tap'),
              { times: Gt, Times: Ut } = e('./times'),
              { timesSeries: Kt, TimesSeries: Ht } = e('./timesSeries'),
              { timesLimit: Qt, TimesLimit: qt } = e('./timesLimit'),
              { using: Jt, Disposer: $t } = e('./using'),
              { resolveStack: Yt, reconstructStack: Xt } = e('./debug'),
              { createProxy: Zt } = e('./internal/mixin');
            (j.VERSION = d),
              (j.resolve = l),
              ...
              (j.config = function(e) {
                (e = e || {}),
                  e.longStackTraces !== void 0 && (L = !!e.longStackTraces),
                  e.cancellation !== void 0 && (j.prototype._execute = e.cancellation ? s : i);
              }),
              (j.longStackTraces = function() {
                L = !0;
              });
            const { CancellationError: er, TimeoutError: tr } = e('./error');
            (j.CancellationError = er), (j.TimeoutError = tr);
        ...
        function(e, t) {
          ...
          function i(e, t) {
            ...
            if (t instanceof p)
              switch (t._resolved) {
                case 0:
                  return void t._addReceiver(e, r);
                case 1:
          ...
          function u(e, t, r, s) {
            ...
            if (!(o > r)) {
              const l = e[t] > e[o] ? t : o;
              (o = c(e, t, r, e[l], s)), u(e, t, o - 1, s), u(e, o, r, s);
            }
          }
          const { AigleCore: p } = e('aigle-core'),
            { version: m } = e('../../package.json'),
            y = { e: void 0 },
            d = 'function' == typeof Symbol ? Symbol.iterator : function() {};
          t.exports = {
            VERSION: m,
            DEFAULT_LIMIT: 8,
            INTERNAL: r,
            ...
            callResolve: function(e, t, r) {
              ...
              const s = l(t, r);
              return s === y ? void e._reject(y.e) : void i(e, s);
            },
            ...
            callProxyReciever: function(e, t, r) {
              ...
              return e === y ? (t._callReject(y.e), !1) : (e && e.then ? o(e, t, r) : t._callResolve(e, r), !0);
            },
            promiseArrayEach: function(e) {
              ...
              for (let l = -1; ++l < t; ) {
                ...
                t && t.then ? o(t, e, l) : e._callResolve(t, l);
              }
            },
            promiseObjectEach: function(e) {
              ...
              for (let _ = -1; ++_ < t; ) {
                ...
                i && i.then ? o(i, e, t) : e._callResolve(i, t);
              }
            },
            promiseMapEach: function(e) {
              ...
              for (let l; !1 === (l = r.next()).done; ) {
                ...
                i && i.then ? o(i, e, r) : e._callResolve(i, r);
              }
            },
            promiseSetEach: function(e) {
              ...
              for (let r = -1, l; !1 === (l = t.next()).done; ) {
                ...
                t && t.then ? o(t, e, ++r) : e._callResolve(t, ++r);
              }
            },
            ...
            clone: function(e) {
              return Array.isArray(e) ? _(e) : a(e);
            },
      ...
      55: [
        function(e, t) {
          ...
          const s = e('./aigle'),
            { INTERNAL: o } = e('./internal/util'),
            _ = 'function' == typeof setImmediate ? setImmediate : {},
            a =
              (() => {
                try {
          ...
          t.exports = function(e, t) {
            switch (typeof e) {
              ...
              case 'function':
                ...
                const o = t && t.context !== void 0 ? t.context : void 0;
                return i(e, o);
              default:
              ...
              if (!t.setImmediate) {
                ...
                (h = h && h.setTimeout ? h : t),
                  '[object process]' === {}.toString.call(t.process)
                    ...
                    : _()
                      ? a()
                      : t.MessageChannel ? c() : d && 'onreadystatechange' in d.createElement('script') ? n() : u(),
                  (h.setImmediate = r),
                  (h.clearImmediate = l);
              }
        ...
        function(e, t, r) {
          (function(t, l) {
            ...
            function c(e, t) {
              ...
              return v(t)
                ? e.stylize('' + t, 'number')
                : d(t) ? e.stylize('' + t, 'boolean') : h(t) ? e.stylize('null', 'null') : void 0;
            }
            function u(e) {
            ...
            function n(e, t, r, l, i, s) {
              ...
              if (
                ...
                c.get
                  ? c.set ? (_ = e.stylize('[Getter/Setter]', 'special')) : (_ = e.stylize('[Getter]', 'special'))
