      ...
      2: [
        function(e, t) {
          (function(r) {
            ...
            function c(e, t) {
              return E && rr(t), 0 !== e._resolved && y(e), (e._receiver = t), t._promise;
            }
            ...
            class j extends u {
              ...
              isCancelled() {
                return this._value instanceof sr;
              }
              value() {
              ...
              cancel() {
                if (this._execute !== i && 0 === this._resolved) {
                  ...
                  (this._resolved = 2),
                    (this._value = new sr('late cancellation observer')),
                ...
                if (0 === this._resolved)
                  return (
                    ...
                    void 0 === this._receiver
                      ...
                      : void (E && lr(this), this._callReject())
                  );
              }
              _callReject() {
                const { _receiver: e } = this;
            ...
            const { all: A, All: N } = e('./all'),
              ...
              { findIndexLimit: je, FindIndexLimit: Ae } = e('./findIndexLimit'),
              { findKey: Ne, FindKey: be } = e('./findKey'),
              ...
              { pickBySeries: Me, PickBySeries: we } = e('./pickBySeries'),
              ...
              Ht = e('./thru'),
              Qt = e('./tap'),
              { times: qt, Times: Jt } = e('./times'),
              { timesSeries: $t, TimesSeries: Yt } = e('./timesSeries'),
              { timesLimit: Xt, TimesLimit: Zt } = e('./timesLimit'),
              { using: er, Disposer: tr } = e('./using'),
              { resolveStack: rr, reconstructStack: lr } = e('./debug'),
              { createProxy: ir } = e('./internal/mixin');
            (j.VERSION = d),
              (j.Aigle = j),
              (j.resolve = l),
            ...
            const { CancellationError: sr, TimeoutError: or } = e('./error');
            (j.CancellationError = sr), (j.TimeoutError = or);
          ...
          (function(r) {
            ...
            t.exports = {
              ...
              callResolve: function(e, t, r) {
                ...
                const l = i(t, r);
                return l === v ? void e._reject(v.e) : void s(e, l);
              },
          ...
          (function(t, l) {
            ...
            function p(e, t, r, s, o) {
              for (var _ = [], a = 0, i = t.length; a < i; ++a)
                N(t, a + '') ? _.push(n(e, t, r, s, a + '', !0)) : _.push('');
              return (
