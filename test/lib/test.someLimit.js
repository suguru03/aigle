...
parallel('someLimit', () => {
  it('should execute', () => {
    ...
    return Aigle.someLimit(collection, 2, iterator).then(res => {
  ...
  it('should return an empty array if collection is an empty array', () => {
    ...
    return Aigle.someLimit([], iterator).then(res => assert.strictEqual(res, false));
  });
  ...
  it('should return an empty array if collection is string', () => {
    ...
    return Aigle.someLimit('test', iterator).then(res => assert.strictEqual(res, false));
  });
