...
parallel('mapValuesLimit', () => {
  it('should execute', () => {
    ...
    return Aigle.mapValuesLimit(collection, 2, iterator).then((res) => {
  ...
  it('should return an empty object if collection is an empty array', () => {
    ...
    return Aigle.mapValuesLimit([], iterator).then((res) => {
      assert.strictEqual(Object.prototype.toString.call(res), '[object Object]');
      assert.deepStrictEqual(res, {});
    });
  });
  ...
  it('should return an empty object if collection is string', () => {
    ...
    return Aigle.mapValuesLimit('test', iterator).then((res) => {
      assert.strictEqual(Object.prototype.toString.call(res), '[object Object]');
      assert.deepStrictEqual(res, {});
    });
  });
