...
parallel('findLimit', () => {
  it('should execute', () => {
    ...
    return Aigle.findLimit(collection, 2, iterator).then(res => {
  ...
  it('should return an empty array if collection is an empty array', () => {
    ...
    return Aigle.findLimit([], iterator).then(res => assert.strictEqual(res, undefined));
  });
  ...
  it('should return an empty array if collection is string', () => {
    ...
    return Aigle.findLimit('test', iterator).then(res => assert.strictEqual(res, undefined));
  });
