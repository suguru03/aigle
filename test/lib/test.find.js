...
parallel('find', () => {
  it('should execute in parallel', () => {
    ...
    return Aigle.find(collection, iterator).then(res => {
  ...
  it('should return undefined if collection is an empty array', () => {
    ...
    return Aigle.find([], iterator).then(res => assert.strictEqual(res, undefined));
  });
  ...
  it('should return undefined if collection is string', () => {
    ...
    return Aigle.find('test', iterator).then(res => assert.strictEqual(res, undefined));
  });
...
parallel('#find', () => {
  ...
  it('should execute using string shorthand with array', () => {
    ...
    const promise = Aigle.resolve(collection)
      .find('bool')
      .then(res => {
        assert.deepStrictEqual(res, { uid: 4, bool: 1 });
