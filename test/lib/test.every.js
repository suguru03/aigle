...
parallel('every', () => {
  it('should execute in parallel', () => {
    ...
    return Aigle.every(collection, iterator).then(res => {
      assert.strictEqual(res, false);
      assert.deepStrictEqual(order, [[0, 1], [2, 2]]);
    });
  });
  ...
  it('should execute with object collection in parallel', () => {
    ...
    return Aigle.every(collection, iterator).then(res => {
      assert.strictEqual(res, false);
      assert.deepStrictEqual(order, [['task1', 1], ['task3', 2]]);
    });
  });
  ...
  it('should execute using string shorthand with an array', () => {
    ...
    let sync = true;
    const promise = Aigle.every(collection, 'test').then(bool => {
  ...
  it('should return true if collection is an empty array', () => {
    ...
    return Aigle.every([], iterator).then(res => assert.strictEqual(res, true));
  });
  ...
  it('should return true if collection is string', () => {
    ...
    return Aigle.every('test', iterator).then(res => assert.strictEqual(res, true));
  });
